...
public class ProfileEditServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (!Security.isActiveSession(request, response)) {
			...
			getServletConfig().getServletContext().getRequestDispatcher(ViewUrls.EDIT_PROFILE_JSP.toString())
					.forward(request, response);
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("login") != null && request.getParameter("new_login") != null) {
			if (!request.getParameter("login").equals(request.getParameter("new_login"))
					...
					&& request.getParameter("login").equals(loginDto.getLogin())) { // &&request.getParameter("login").equals(loginDto.getLogin()
																					// yskcho minyaempsw to maem minyaty
																					// sesiy
				...
				response.sendRedirect(request.getContextPath() + ControllerUrls.PROFILE_EDIT_SERVLET.toString());
		...
		if (request.getParameter("previous_password") != null && request.getParameter("new_password") != null
