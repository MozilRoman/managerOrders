...
public class OrderCountServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		Cookie cookie = new Cookie("visible_orders", request.getParameter("visibleOrders"));
		response.addCookie(cookie);

		if (request.getParameter("redirectURLInOrderCount").equals(RedirectURLInOrderCount.ORDERS_SERVLET.toString())) {
			...
			response.sendRedirect(request.getContextPath() + ControllerUrls.ORDERS_USERS_ADMIN_SERVLET.toString());
		}
